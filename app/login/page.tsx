        ...
        <div className="bg-white py-8 px-4 shadow-lg rounded-2xl sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                type="button"
                className="w-full flex items-center justify-center gap-3 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-colors"
              >
